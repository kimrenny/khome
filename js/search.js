...
document.addEventListener("DOMContentLoaded", function(){
    ...
    */
    ...
    function saveEngineToLocalStorage(engine){
        localStorage.setItem("search_engine", engine.id);
    }

    function loadEngineFromLocalStorage(){
        //console.log("Load Engine From Local Storage: ", localStorage.getItem("search_engine"));
        return localStorage.getItem("search_engine");
    }

    function setInitialEngine(){
        const savedEngine = loadEngineFromLocalStorage();
