document.addEventListener("DOMContentLoaded", function(){
    const clockCounter = document.getElementById("clock");
    ...
    const savedIs24HourFormat = localStorage.getItem("is24HourFormat");
    if(savedIs24HourFormat !== null){
        is24HourFormat = savedIs24HourFormat === "true";
    }
